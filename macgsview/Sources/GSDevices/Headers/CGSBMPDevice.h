/* ============================================================================	*/
/*	CGSBMPDevice.h							written by Bernd Heller in 1999		*/
/* ----------------------------------------------------------------------------	*/
...
#ifndef _H_CGSBMPDevice
#define _H_CGSBMPDevice
#pragma once

#include "CGSDevice.h"


class CGSBMPDevice : public CGSDevice
{
	public:
							CGSBMPDevice(CGSDocument* inDocument = 0);
		
	protected:
		virtual void		HandleRenderingPanel(GSExportPanelMode inMode, LView* inView, MessageT inMsg);
};

#endif _H_CGSBMPDevice
