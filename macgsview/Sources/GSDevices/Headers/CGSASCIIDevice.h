/* ============================================================================	*/
/*	CGSASCIIDevice.h						written by Bernd Heller in 2000		*/
/* ----------------------------------------------------------------------------	*/
...
#ifndef _H_CGSASCIIDevice
#define _H_CGSASCIIDevice
#pragma once

#include "CGSDevice.h"


class CGSASCIIDevice : public CGSDevice
{
	public:
							CGSASCIIDevice(CGSDocument* inDocument=0);
							~CGSASCIIDevice();
		
		void				SetDeviceShowsPageRange(bool inFlag)
							{ mShowDialog = inFlag; }
