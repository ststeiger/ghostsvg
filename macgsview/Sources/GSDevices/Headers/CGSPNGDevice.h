/* ============================================================================	*/
/*	CGSPNGDevice.h							written by Bernd Heller in 1999		*/
/* ----------------------------------------------------------------------------	*/
...
#ifndef _H_CGSPNGDevice
#define _H_CGSPNGDevice
#pragma once

#include "CGSDevice.h"


class CGSPNGDevice : public CGSDevice
{
	public:
							CGSPNGDevice(CGSDocument* inDocument=0);
		
	protected:
		virtual void		HandleRenderingPanel(GSExportPanelMode inMode, LView* inView, MessageT inMsg);
};

#endif _H_CGSPNGDevice
