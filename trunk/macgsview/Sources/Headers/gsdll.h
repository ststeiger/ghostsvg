...
#define GSDLL_POLL 7		/* Called from gp_check_interrupt */
			...
			/* returns */
//#define GSDLL_STDERR 8		/* put count characters from str to stderr */
...
typedef int (GSDLLAPI * PFN_gsdll_init) (GSDLL_CALLBACK callback, HWND hwnd, int argc, char GSFAR * GSFAR * argv);
