/* ============================================================================	*/
/*	CGSTIFFDevice.h							written by Bernd Heller in 1999		*/
/* ----------------------------------------------------------------------------	*/
...
#ifndef _H_CGSTIFFDevice
#define _H_CGSTIFFDevice
#pragma once

#include "CGSDevice.h"


class CGSTIFFDevice : public CGSDevice
{
	public:
							CGSTIFFDevice(CGSDocument* inDocument=0);
		
	protected:
		virtual void		HandleRenderingPanel(GSExportPanelMode inMode, LView* inView, MessageT inMsg);
};

#endif _H_CGSTIFFDevice
