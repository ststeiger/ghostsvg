/* ============================================================================	*/
/*	CGSPSDevice.h							written by Bernd Heller in 2000		*/
/* ----------------------------------------------------------------------------	*/
/*	device wrapper class for "pswrite"											*/
/* ============================================================================	*/
...
#ifndef _H_CGSPSDevice
#define _H_CGSPSDevice
#pragma once

#include "CGSPSDFDevice.h"


class CGSPSDevice : public CGSPSDFDevice
{
	public:
							CGSPSDevice(CGSDocument* inDocument=0);
};

#endif _H_CGSPSDevice
