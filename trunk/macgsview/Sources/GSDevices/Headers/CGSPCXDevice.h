/* ============================================================================	*/
/*	CGSPCXDevice.h							written by Bernd Heller in 1999		*/
/* ----------------------------------------------------------------------------	*/
...
#ifndef _H_CGSPCXDevice
#define _H_CGSPCXDevice
#pragma once

#include "CGSDevice.h"


class CGSPCXDevice : public CGSDevice
{
	public:
							CGSPCXDevice(CGSDocument* inDocument=0);
		
	protected:
		virtual void		HandleRenderingPanel(GSExportPanelMode inMode, LView* inView, MessageT inMsg);
};

#endif _H_CGSPCXDevice
