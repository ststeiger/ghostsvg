/* ============================================================================	*/
/*	CGSJPEGDevice.h							written by Bernd Heller in 1999		*/
/* ----------------------------------------------------------------------------	*/
...
#ifndef _H_CGSJPEGDevice
#define _H_CGSJPEGDevice
#pragma once

#include "CGSDevice.h"


class CGSJPEGDevice : public CGSDevice
{
	public:
							CGSJPEGDevice(CGSDocument* inDocument=0);
	...
	protected:
		...
		virtual void		HandleJPEGQualityPanel(GSExportPanelMode inMode, LView* inView, MessageT inMsg);
