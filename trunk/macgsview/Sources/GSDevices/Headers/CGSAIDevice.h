/* ============================================================================	*/
/*	CGSAIDevice.h							written by Bernd Heller in 2000		*/
/* ----------------------------------------------------------------------------	*/
...
#ifndef _H_CGSAIDevice
#define _H_CGSAIDevice
#pragma once

#include "CGSDevice.h"


class CGSAIDevice : public CGSDevice
{
	public:
							CGSAIDevice(CGSDocument* inDocument=0);
