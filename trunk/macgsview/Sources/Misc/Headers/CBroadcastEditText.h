/* ============================================================================	*/
/*	CBroadcastEditText.h					written by Bernd Heller in 1999		*/
/* ----------------------------------------------------------------------------	*/
...
#ifndef _H_CBroadcastEditText
#define _H_CBroadcastEditText
#pragma once
...
class CBroadcastEditText : public LEditText
{
	public:
				enum { class_ID = FOUR_CHAR_CODE('Betx') };
